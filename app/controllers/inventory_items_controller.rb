class InventoryItemsController < ApplicationController
  ...
  def index
    @inventory_items = InventoryItem.all
     ...
     @page = (params[:page] || 0).to_i
      ...
      @inventory_items, @number_of_pages = search.inventory_items_by_name
  end
  ...
  private
    ...
    def inventory_item_params
      params.require(:inventory_item).permit(:inventory_id, :item_id, :code_item, :name_item, :description_item, :quantity_product, :price_purchase_total, :price_sale_total, :variance, :user_id)
    end
end
