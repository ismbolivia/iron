...
class BankAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_account" do
    assert_difference('BankAccount.count') do
      post bank_accounts_url, params: { bank_account: { bank_id: @bank_account.bank_id, number: @bank_account.number, titular: @bank_account.titular } }
    end
  ...
  test "should update bank_account" do
    patch bank_account_url(@bank_account), params: { bank_account: { bank_id: @bank_account.bank_id, number: @bank_account.number, titular: @bank_account.titular } }
