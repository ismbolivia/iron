...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post deposits_url, params: { deposit: { bank_account_id: @deposit.bank_account_id, client_id: @deposit.client_id, payment_id: @deposit.payment_id, rode: @deposit.rode } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { bank_account_id: @deposit.bank_account_id, client_id: @deposit.client_id, payment_id: @deposit.payment_id, rode: @deposit.rode } }
