...
class PaymentTermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_term" do
    assert_difference('PaymentTerm.count') do
      post payment_terms_url, params: { payment_term: { active: @payment_term.active, company_id: @payment_term.company_id, create_uid: @payment_term.create_uid, name: @payment_term.name, note: @payment_term.note } }
    end
  ...
  test "should update payment_term" do
    patch payment_term_url(@payment_term), params: { payment_term: { active: @payment_term.active, company_id: @payment_term.company_id, create_uid: @payment_term.create_uid, name: @payment_term.name, note: @payment_term.note } }
