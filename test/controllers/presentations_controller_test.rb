...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { name: @presentation.name, qty: @presentation.qty, unit_id: @presentation.unit_id } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { name: @presentation.name, qty: @presentation.qty, unit_id: @presentation.unit_id } }
