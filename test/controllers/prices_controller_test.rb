...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { active: @price.active, item_id: @price.item_id, name: @price.name, price_purchase: @price.price_purchase, price_sale: @price.price_sale, utility: @price.utility } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { active: @price.active, item_id: @price.item_id, name: @price.name, price_purchase: @price.price_purchase, price_sale: @price.price_sale, utility: @price.utility } }
