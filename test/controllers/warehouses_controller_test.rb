...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { active: @warehouse.active, description: @warehouse.description, name: @warehouse.name, ref: @warehouse.ref } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { active: @warehouse.active, description: @warehouse.description, name: @warehouse.name, ref: @warehouse.ref } }
