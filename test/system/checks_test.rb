...
class ChecksTest < ApplicationSystemTestCase
  ...
  test "creating a Check" do
    ...
    fill_in "Bank", with: @check.bank_id
    fill_in "Date giro", with: @check.date_giro
    fill_in "Date payment", with: @check.date_payment
    fill_in "Number", with: @check.number
    fill_in "Titular", with: @check.titular
