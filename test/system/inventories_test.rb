...
class InventoriesTest < ApplicationSystemTestCase
  ...
  test "creating a Inventory" do
    ...
    fill_in "Name Company", with: @inventory.name_company
    fill_in "Name Warehouse", with: @inventory.name_warehouse
    fill_in "Quantity", with: @inventory.quantity
    fill_in "Ref", with: @inventory.ref
    fill_in "Ref Warehouse", with: @inventory.ref_warehouse
    fill_in "Sales Value", with: @inventory.sales_value
